...
let lastCar = 0;
console.log(`Car 33 is a ${inventory[inventory.length-1].car_year} ${inventory[inventory.length-1].car_make} ${inventory[inventory.length-1].car_model}` );
...
console.log("List of BMW and Audi cars: " + JSON.stringify(BMWAndAudi));
